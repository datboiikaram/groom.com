  ...
  return (
    ...
    >
      <img
        ...
        alt="person image"
      />
      <p className="w-fit text-xl font-bold">{item?.name}</p>
      <div className="flex items-center justify-center w-full gap-2 ">
        ...
        <button
          ...
          className=" bg-violet-200 hover:bg-violet-300 text-violet-800 font-bold border-2 py-1 w-full rounded-md duration-250 "
        >
          حجز
        </button>
      </div>
